...
def workflow_approvals():
    ...
    if request.method == "GET":
        ...
        return render_template(get_app_vertical()+"/workflow-approvals.html", templatename=get_app_vertical(),workflow_list=workflow_list, config=session[SESSION_INSTANCE_SETTINGS_KEY],_scheme="https")
...
def workflow_requests():
    ...
    if request.method == "GET":
        ...
        return render_template(get_app_vertical()+"/workflow-requests.html", templatename=get_app_vertical(),workflow_list=workflow_list, config=session[SESSION_INSTANCE_SETTINGS_KEY],_scheme="https")
    if request.method == "POST":
